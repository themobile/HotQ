...
JustGage = function(config) {
    ...
    obj.config = {
        ...
        valueFontColor: obj.kvLookup('valueFontColor', config, dataset, "rgba(255,255,255,0.5)"),
        ...
        levelColors: obj.kvLookup('levelColors', config, dataset, ["#000", "#000", "#000"], 'array', ','),
        ...
        valueMinFontSize: obj.kvLookup('valueMinFontSize', config, dataset, 35),
