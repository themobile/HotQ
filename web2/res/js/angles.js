...
angles.chart = function (type) {
    return {
        ...
        link: function ($scope, $elem) {
            ...
            var elemDim = $elem[0].getClientRects()['0'];
            ...
            if ($scope.width <= 0) {
                ...
                if (elemDim.height < elemDim.width) {
                    ctx.canvas.width = elemDim.height;
                    ctx.canvas.height = elemDim.height;
                } else {
                    ctx.canvas.width = elemDim.width;
                    ctx.canvas.height = elemDim.width;
                }
            }
